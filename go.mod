...
require (
	...
	github.com/lightninglabs/lightning-node-connect v0.1.8-alpha.0.20220329163114-92a05e836b9c
...
replace github.com/lightningnetwork/lnd => github.com/guggero/lnd v0.11.0-beta.rc4.0.20220329174130-ac098d776c05

replace github.com/lightninglabs/lightning-node-connect => ../lightning-node-connect
